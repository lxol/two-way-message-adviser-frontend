...
class JavascriptController @Inject()(val authConnector: AuthConnector, val strideUtil: StrideUtil)(
  implicit ec: ExecutionContext)
    extends FrontendController with AuthorisedFunctions {

  def javascriptRoutes: Action[AnyContent] = Action.async { implicit request =>
